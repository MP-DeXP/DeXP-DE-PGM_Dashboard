    ...
    rules = [
        {
            ...
            "priority": 1,
            "title_ko": "AA-Broad 유입 후 PCA 전환 강화",
            "action_ko": "첫구매 7일 내 PCA-Core 유도 CRM/리타게팅 캠페인을 우선 실행합니다.",
            "impact_ko": "유입 낭비 축소 및 90일 전이율 개선",
        },
        {
            ...
            "action_ko": "상위 경로를 유지하면서 대체 PCA 노출 A/B 테스트를 병행합니다.",
            "impact_ko": "경로 리스크 분산",
        },
        {
            "rule_id": "mk_slow_pca",
        ...
        },
        {
            ...
            "priority": 1,
            "title_ko": "CA-Pair 고정 번들 운영",
            "action_ko": "상위 Pair 상품의 고정 번들/교차추천 슬롯을 우선 운영합니다.",
            "impact_ko": "장바구니 확장률 향상",
        },
        {
