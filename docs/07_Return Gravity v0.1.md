...
Return Gravity는 제품이 고객을 다시 자기 자신으로 끌어당기는 힘을 설명한다.
...
즉 Return Gravity는
고객이 다른 제품을 거친 뒤 다시 같은 제품으로 돌아오는 구조를 포착한다.
...
- 같은 제품만 연속 구매하는 경우
- 다른 제품을 탐색한 뒤 다시 특정 제품으로 복귀하는 경우

실무적으로 중요한 것은 두 번째다.
왜냐하면 그 제품은 단순히 “자주 사는 제품”이 아니라,
수요 사이클의 중심이기 때문이다.
...
특정 제품 `A`의 고객별 첫 구매 이후 90일 내 시퀀스에서,
`A`가 다시 등장하되 그 사이에 `A`가 아닌 다른 제품이 1개 이상 존재하면
...
재구매율은 같은 제품이 다시 팔렸는지만 본다.
Return Gravity는 그 사이에 다른 제품 전이가 있었는지를 본다.
...
Return Gravity가 높은 제품은 다음과 같이 해석할 수 있다.

- `Anchor Product`
- `Loop-Center Product`
- `Routine-Return Product`

이 제품은 고객이 여러 제품을 거친 뒤에도 다시 돌아오는 중심점이다.
...
즉 낮은 매출 제품도 높은 Return Gravity를 가질 수 있다.
