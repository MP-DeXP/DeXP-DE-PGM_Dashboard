...
## 목적
`BII`는 브랜드의 구조 건강도(`BHI`)가 기간별 브랜드 구매력으로 얼마나 발현되고 있는지를 측정하는 다기간 지표다.

Brand Score가 브랜드의 구조를 본다면, BII는 그 구조가 최근 운영 구간에서 어떤 수준의 브랜드 구매력으로 나타나는지를 본다.
...
즉 BII는 매출 총액이 아니라 `구조의 브랜드 구매력 발현 상태`를 본다.
...
- 따라서 이 시계열은 `구조 점수의 역사`가 아니라 `현재 구조를 기준으로 본 브랜드 구매력의 최근 추이`로 해석해야 한다.
...
## Brand Momentum
`Brand Momentum`은 `BII`의 별도 원천 지표가 아니라, 최근 브랜드 구매력을 연간 기준선과 비교하는 파생 해석 지표다.

One-liner:

- `BHI`: 브랜드 구조
- `BII`: 브랜드 구매력
- `Momentum`: 브랜드 구매력의 장기 기준 대비 상대 강도
...
- `BII_t`: 최근 기간 브랜드 구매력
- `BII_365`: 연간 기준 브랜드 구매력 baseline

대표 예시는 아래와 같다.

- `Momentum_7 = BII_7 / BII_365`
- `Momentum_30 = BII_30 / BII_365`
- `Momentum_90 = BII_90 / BII_365`

해석:

- `Momentum > 1.0`: 최근 브랜드 구매력이 연간 기준보다 강하다
- `Momentum = 1.0`: 최근 브랜드 구매력이 연간 기준과 유사하다
- `Momentum < 1.0`: 최근 브랜드 구매력이 연간 기준보다 약하다

이 값은 보통 아래 질문에 답하는 데 사용한다.

- 최근 브랜드 구매력이 장기 기준 대비 강화되고 있는가
- 최근 운영이 브랜드 구매력을 받쳐주고 있는가
- 단기 프로모션이 구매력을 일시적으로 밀어올렸는가
- 구조 대비 최근 구매력이 약화되고 있는가
