...
- role_same_date_snapshot: pass - Role taxonomy는 as_of_date + window_key 기준 기간형 row로 생성합니다.
- brand_score_queue_exclusion: pass - Brand Score는 큐 보조 상태로만 유지됩니다.
- brand_score_panel_singleton: pass - Brand Score panel은 1d/7d/30d brand-level row 계약으로 생성됩니다.
- brand_score_numeric_policy: pass - limited/unavailable 상태의 숫자 노출 정책이 정상 적용되었습니다.
- product_image_provenance: pass - 상품 이미지는 Rosetta 적재 결과를 직접 사용합니다.
- revenue_history_ready: pass - Revenue 30/90일 비교를 위한 history가 확보되었습니다.
- revenue_compare_population: pass - 선택 기간 기준 Revenue 비교 가능 상품이 존재합니다.
...
- brand_revenue_context_present: pass - 브랜드 기간별 Revenue 컨텍스트가 큐 요약에 포함되어 있습니다.
